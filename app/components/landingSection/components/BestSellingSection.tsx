...
export default function BestSellingSection() {
  return (
    <section className="md:max-w-7xl w-full mx-auto py-16">
      <div className="flex flex-col md:flex-row items-center justify-start gap-4">
        <div className="flex-1 rounded-lg md:px-0 px-4 flex flex-col justify-center items-center md:items-start md:justify-start">
          ...
          <div className={poppins.className}>
            <p className="text-[#1E1E1E80] md:mb-8 mb-4 text-center md:text-start">
  ...
  <div className=" flex-4 flex flex-col md:flex-row md:space-x-4 space-y-2 justify-between">
    {products.map(({ imgSrc, title, price }, idx) => (
          ...
          >
            <img
              src={imgSrc}
              alt={title}
              className="md:w-72 md:h-82 w-62 h-68 object-cover rounded-md mb-4"
            />
            <div className={poppins.className}>
