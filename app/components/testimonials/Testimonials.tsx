...
const Testimonial = () => (
  <section className="bg-white py-12 w-full relative min-h-[600px]">
    <div className="max-w-7xl mx-auto px-6 relative">
      {/* Top-right rectangle images container */}
      <div className="absolute top-6 right-2 flex items-center gap-0">
        {/* Adjust sizes to show ___  __  _ style */}
        <img src={rectangleImages[0]} alt="Rectangle Large" className="h-6 w-8 object-contain" />
        <img src={rectangleImages[1]} alt="Rectangle Medium" className="h-1 w-8 object-contain" />
        <img src={rectangleImages[2]} alt="Rectangle Small" className="h-1 w-8 object-contain" />
      </div>
